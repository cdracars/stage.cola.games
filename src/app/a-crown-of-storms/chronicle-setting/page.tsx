...
export default function ACrownOfStormsChronicleSettingPage() {
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10 text-center">
        <Image
        ...
        <div className="space-y-6 text-left">
          ...
          >
            ...
            <p>
              ...
              both hunger and fear. Against expectation, it didn’t just survive. It
              thrived.
            </p>
            <p>
              ...
              King Alaric challenged her to a duel to the deat<div
            className={`${dellaRespira.className} space-y-4 leading-relaxed`}
            style={{ fontSize: "11px" }}
          ></div>h. He lost. By the
            ...
            <p>
              ...
              Caelithae—appear to cooperate with Velistra as <div
            className={`${dellaRespira.className} space-y-4 leading-relaxed`}
            style={{ fontSize: "11px" }}
          ></div>the final day
        ...
        <div className="space-y-10 text-left">
          ...
          <div className="space-y-6">
            ...
            <p
              ...
              style={{ fontSize: "11px", color: "#f1c232" }}
            >
              “A kingdom without hope is already conquered.”
              <br />— Dawn Caelithae, Duchess of Singing Grass
            </p>
            <p
              className={`${dellaRespira.className} leading-relaxed`}
              style={{ fontSize: "11px" }}
            >
              Stillwater is a place of quiet radiance. Wind moves through tall grass
              and shaded groves, carrying dreams shaped by study, art, and shared
              hope. The Dreaming here is gentle but resilient, fed by imagination,
              learning, and the belief that the future can be better if it is
              carefully tended. Princess Dawn Caelithae rules with compassion and
              trust, nurturing a Seelie court built on inspiration rather than fear.
              Stillwater has not yet been hardened by war, and that innocence is both
              its greatest strength and its greatest risk.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p
              ...
              style={{ fontSize: "11px", color: "#f1c232" }}
            >
              “We don’t earn tomorrow by waiting.”
              <br />— Cole Thornridge, Duke of the Open Road
            </p>
            <p
              className={`${dellaRespira.className} leading-relaxed`}
              style={{ fontSize: "11px" }}
            >
              Tulsa is shaped by motion and possibility. Wide skies, long roads, and
              the promise of somewhere better just ahead feed a Dreaming born of
              ...
              of an old road town—firm, fair, and trusted to stand between danger and
              those who cannot. Tulsa values loyalty, shared responsibility, and
          ...
          <div className="space-y-6">
            ...
            <h3
              ...
              style={{ fontSize: "14px", color: "#f1c232" }}
            >
              The Duchy of Crow &amp; Coin, Oklahoma City
            </h3>
            <p
              className={`${dellaRespira.className} italic`}
              style={{ fontSize: "11px", color: "#f1c232" }}
            >
              “I protect me and mine. Any ‘king’ ought to do the same — or they’re no
              king of mine.”
            ...
            >
              ...
              does not reject the idea of a monarch—but it will never accept one who
              has not earned belief.
            </p>
          </div>
        </div>
      </div>
