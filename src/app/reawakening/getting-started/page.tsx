...
export default function ReawakeningChroniclePage() {
  return (
    <Box className="bg-gray-900 text-gray-300">
      {/* Hero Section */}
      <Hero
        src="/images/reawakening-getting-started-banner.png"
      ...
      <MiniBanner
        src="/images/reawakening-about-out-chronicle.png"
        alt="About out chronicle"
      />

      <MiniBanner
        src="/images/okc-at-night.png"
      ...
      <MiniBanner
        src="/images/lines-and-veils.png"
        alt="Reawakening Event Banner"
      />
      ...
      <MiniBanner src="/images/veil.png" alt="Reawakening Event Banner" />
      ...
      <Box className="page-section">
        ...
        <List.Root className="list-disc list-inside space-y-2 font-marcellus">
          <List.Item>
            <span className="text-brand-500">Sexual Assault of any kind</span>
            <br />
            Please be aware that some Vampires may seduce mortals to feed, but
            any resulting sexual activity must always be consensual and will
            observe a “fade to black” rule (see below).
          </List.Item>
          <List.Item>
            ...
            <br />
            Vampires don’t care about these things any longer, though they may
            definitely still have discriminatory views on other characters’
            clans, backgrounds, social standing, etc. We understand that
            vampires are long-lived, and history is full of examples of this
            kind of bigotry, but hatred should never be central to a character’s
      ...
      <Box className="page-section">
        ...
        <List.Root className="list-disc list-inside space-y-2 font-marcellus">
          ...
          <List.Item>
            Intense scenes of violence, such as torture, excessive gore, etc.
          </List.Item>
          <List.Item>
            Other intense or graphic content as determined by the participants
            or storyteller in the scene.
          </List.Item>
        </List.Root>
      </Box>
      ...
      <Box className="page-section">
        ...
        >
          <List.Item>
            <strong>No Touching Without Permission</strong> - No player should
            engage in actual physical roleplay with another player without their
            express consent. Simply use the out-of-character gesture (crossed
            fingers) and ask, “Do you mind if I (action here)?” Please make sure
            requests are respectful, and also respect the player’s answer when
            given.
            <br />
            <br />
            <span className="text-brand-500">
              Absolutely no overtly sexual, violent or harmful physical roleplay
              is allowed (actual fighting, sex acts, biting, drawing blood,
              etc.), <strong>even with consent</strong>
            </span>
            . Actions of this kind will result in immediate ejection from the
            event.
          </List.Item>
          <List.Item>
            <strong>No Weapons or Weapon Props</strong> - Even weapon props can
            often be mistaken for the real thing. In order to ensure our
            players, staff and hosts all feel safe, weapons and weapon props are
            not allowed at game.
          </List.Item>
          <List.Item>
            <strong>No alcohol or recreational drug use</strong> - This includes
            arrival to the event visibly intoxicated. Intoxicated players will
            be asked to leave the event.
          </List.Item>
          <List.Item>
            <strong>No Minors</strong> - Due to the mature themes of Vampire:
            the Masquerade, nobody under the age of 18 years will be allowed at
            game.
          </List.Item>
          <List.Item>
            <strong>Use the Safety Tools at game</strong> - Before the game, our
            staff will explain our check-in system and any safety tools in use
            for that game, as well as cover where out-of-character decompression
            spaces are located. We will also print out copies of the safety
            tools to reference at game. Please take note and make use of these.
          </List.Item>
          <List.Item>
            <strong>No other antisocial or disruptive behavior</strong> - This
            is to catch any additional behavior with a negative impact to the
            game or its players not otherwise covered here. Long story short,
            please just try to be a cool human being.
          </List.Item>
        </List.Root>
      </Box>
      ...
      <Box className="pb-16 text-center">
        <MiniBanner src="/images/handshake.png" alt="Call to Action" />
